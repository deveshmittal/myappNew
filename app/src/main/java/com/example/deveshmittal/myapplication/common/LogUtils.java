...
public class LogUtils {
    private static final String LOG_PREFIX = "[Wynk] ";
    ...
    public static void errorLog(String tag, String message, Throwable ex) {
        getLogger().error(tag, message, ex);
    }
...
*/
     ...
     * http://support
     * .crashlytics.com/knowledgebase/articles/120066-how-do-i-use-logging-
     */
    public static class ProductionLogger extends NoOpLogger {
        ...
        public void error(String tag, String message, Throwable exception) {
           ...
           //     Crashlytics.logException(new Exception(tag, exception));
            }
        }
    }
}
